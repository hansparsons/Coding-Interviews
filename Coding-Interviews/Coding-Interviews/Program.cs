...
namespace Coding_Interviews
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string ls = ReverseString("home");
            string hj = ReverseStringWithoutCollections("home");

            string ab = ReverseWords("This is my home!!!");

            string xy = ReverseWords2("This is my home!!!");

            string iop = ReverseWordsWithoutCollections("This is my home??");

            int[] tempIntArray = new int[] { 1, 3, 4, 7, 9 };
            int tempInt = 6;

            FindSum(tempIntArray, tempInt);
            FindSumWithoutCollections(tempIntArray, tempInt);  
            ...
            var array = RemoveDuplicateIntegers(dupArray);
